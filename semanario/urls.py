...
from .views import criar_semanario, adicionar_material, SemanarioListView, SemanarioView, editar_semanario, listar_materiais, painel_sabado_educ, relatorio_pedagogico, salvar_materiais, VisualizarSemanario
...
urlpatterns = [
    ...
    path("relatorio_pedagogico/", relatorio_pedagogico, name="relatorio_pedagogico"),
]
