...
from .views import criar_semanario, adicionar_material, SemanarioListView, SemanarioView, editar_semanario, listar_materiais, salvar_materiais, VisualizarSemanario
